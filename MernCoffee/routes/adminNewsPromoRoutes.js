...
//     //                                 return console.log(err);
//     //                             });
//     //                             //res.send(promotionImage);
//     //                             // console.log("req.file: \n" + req.files);
//     //                             // console.log("req.file.image: \n" + req.files.image);
//     //                             // cloudinary.uploader.upload(promotionImage.name, {
//     //                             //     public_id: "mern/promotions/" + promotion._id + '/' + imageFile, 
...
//         console.log("field:" + JSON.stringify({ fields, files }, null, 2));
//         var promotion = new Promotion(fields);
//         console.log(promotion);
//         promotion.save()
//         .then((result) => {
//             cloudinary.uploader.upload(files.image.filepath, { public_id: `mern/promotion/${result._id}/${result.nameImage}`,width: 479, height: 340, crop: "scale"})
//             res.redirect('/admin/promotions');
//         })
//         .catch(err => console.log(err));
//     })
